...
export default function Home() {
  ...
  return (
    <>
      ...
      <main
        className={`${styles.mainContainer} container-fluid m-0 m-lg-2 p-0`}
      >
        ...
        <div
          className={`${styles.chatContainer}  d-flex flex-column align-items-center text-center`}
        >
          {/* title */}
          <Image
            src={'/chat-header.jpg'}
          ...
          <div className="d-flex flex-column justify-content-center align-items-center px-2 px-lg-4">
            <div
              className={`${styles.chatSelectBox}  col-12  p-3 d-flex flex-column align-items-center ${styles.boxColor1} me-lg-2 mb-2 mb-lg-0`}
            >
              <Link href={'/chatbot'}>
                <p className="text-dark text-uppercase mb-0">
                  <strong>CONNECT WITH AI ASSISTANT</strong>
                </p>
              </Link>
            </div>
            {/* <div
              className={`${styles.chatSelectBox} col-12  p-3 d-flex flex-column align-items-center ${styles.boxColor2} me-lg-2 mb-2 mb-lg-0`}
            >
              <Link href={'/liveAgent'}>
                <p className="text-dark text-uppercase mb-0">
                  <strong>CONNECT WITH A LIVE AGENT</strong>
                </p>
              </Link>
            </div> */}
            ...
            {/* <div
              className={`${styles.chatSelectBox} col-12  p-3 d-flex flex-column align-items-center ${styles.boxColor4} mb-2 mb-lg-0`}
            >
              <Link href={'/audiobot'}>
                <p className="text-dark text-uppercase mb-0">
                  <strong>CONNECT VIA AUDIO</strong>
                </p>
              </Link>
            </div> */}
          </div>
